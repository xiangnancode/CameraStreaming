...
typedef HI_S32 (*HI_ON_EVENT_CALLBACK)(HI_U32 u32Handle, /* 句柄 */
                                HI_U32 u32Event,      /* 事件 */
...
typedef HI_S32 (*HI_ON_STREAM_CALLBACK)(HI_U32 u32Handle, /* 句柄 */
...
typedef HI_S32 (*HI_ON_NALU_CALLBACK)(HI_U32 u32Handle, /* 句柄 */
								HI_U32 u32DataType,     /* 数据类型，系统数据或音视频数据 */
								HI_U8*  pu8Buffer,      /* 数据包含帧头 */
								HI_U32 u32Length,      /* 数据长度 */
								HI_U32 u32Pts,      /* 数据长度 */
...
#define HI_NET_DEV_KEEP_ALIVE		2
#define HI_NET_DEV_DEC_STATE		3
...
typedef HI_S32 (*HI_ON_DATA_CALLBACK)(HI_U32 u32Handle, /* 句柄 */
...
typedef HI_S32 (*OnUpgradeCallBack)(HI_U32 u32Chn, HI_S32 s32Persent, HI_VOID *pUserData);
...
#define HI_NET_DEV_CMD_BUT						0x1065
